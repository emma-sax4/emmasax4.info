...
In fact, by the time I was done for the day, I had pretty much decided to just do-away with the whole notion of a "set" and turn it into a "category" instead. Actually I like the word "collection" more than a "categor,y so in the codebase it's a "category," in my head it's a "collection," and to an end user of this site, they all look like "tags." So then, I did a _huge_ find/replace of the word `set` and replaced it with the word `category`.
