...
4. Verify tests passes on your pull request. The test configuration lives inside the [`..github/workflows/config.yml`](https://github.com/emma-sax4/emmasax4.info/blob/source/.github/workflows/config.yml) file. Read more about this repository's tests below.
