...
2. Create your feature branch using my custom Git files: `github/new-branch 'my-new-feature'`
...
7. When you're satisfied, make a pull request to this repository: `github/pull-request 'Made some great changes'`
