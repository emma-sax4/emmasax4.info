...
3. "Deploy" my website by making a commit back to my [`gh-pages` branch in GitHub]({{ site.author_profiles.github }}/{{ site.github_repo }}/tree/gh-pages) (which GitHub Pages will then deploy for me)
...
script:
  ...
  - htmlproofer --assume-extension --allow-hash-href --internal-domains /{{ site.domain }}/ ./site
```
