...
1. Rename the repository ([GitHub: emmasax4.com/pull/305]({{ site.author_profiles.github }}/{{ site.github_repo }}/pull/305))
2. Update where the project name is hard-coded ([GitHub: emmasax4.com/pull/306]({{ site.author_profiles.github }}/{{ site.github_repo }}/pull/306))
