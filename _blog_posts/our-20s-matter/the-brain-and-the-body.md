...
Well, as you might've picked up from the title of this blog post, this will be about our brains and our bodies. Therefore, this blog post will cover the following topics, based on [_The Defining Decade_](https://megjay.com/the-defining-decade/) by [Meg Jay](https://megjay.com):
...
However, even if you were a celebrity who had $2 million, the _likelihood_ of these fertility treatments working is quite low. After age 35, intrauterine insemination only has a 5–10% of success. In vitro fertilization has a 10–20% chance of properly working. In fact, the likelihood of treatments working with older women are so low that many clinics won't work with women in their mid-40s; "the failed attempts bring down the success rates the clinics are able to advertise" (page 182).
